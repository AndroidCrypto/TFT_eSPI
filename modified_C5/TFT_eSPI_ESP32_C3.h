...
#define _TFT_eSPI_ESP32H_
 ...
 #warning >>>>------>> DMA is not supported on the ESP32 C3, C5, C6 + H2 (possible future update)
#endif
...
// 1. Sichere Erkennung der Chip-Targets
#if !defined(CONFIG_IDF_TARGET_ESP32H2) && !defined(CONFIG_IDF_TARGET_ESP32C5) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32S2) && !defined(CONFIG_IDF_TARGET_ESP32)
  #define CONFIG_IDF_TARGET_ESP32
#endif
...
// Fallback: Falls die IDF-Makros unvollständig definiert sind, erzwinge C5-Erkennung anhand des Pfads
#if defined(__riscv) && !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32H2)
  #ifndef CONFIG_IDF_TARGET_ESP32C5
    #define CONFIG_IDF_TARGET_ESP32C5 1
  #endif
#endif

// 2. Block NUR für ESP32-C3 und ESP32-C6 (Nutzen die alte Registerstruktur mit DR_REG_SPI0_BASE)
...
// 3. Block für ESP32-H2 und ESP32-C5 (Moderne Registerstruktur OHNE DR_REG_SPI0_BASE)
#if defined(CONFIG_IDF_TARGET_ESP32H2) || defined(CONFIG_IDF_TARGET_ESP32C5)
  #ifdef REG_SPI_BASE
    #undef REG_SPI_BASE
  #endif
  // Verhindert den Absturz, indem nur die existierende SPI2 Basis verwendet wird
  #define REG_SPI_BASE(i) (((i)==2) ? (DR_REG_SPI2_BASE) : (DR_REG_SPI2_BASE - 0x1000)) 
  ...
  // Manuelle Definition der Buffer-Register für die C3.c Ausgabebefehle
  #undef SPI_W0_REG
  ...
  // Behebt den "invalid operands to binary operator|" Fehler im ESP32-C5 Core
  #ifdef SET_PERI_REG_MASK
    #undef SET_PERI_REG_MASK
    #define SET_PERI_REG_MASK(reg, mask) REG_SET_BIT((reg), (mask))
  #endif
  #ifdef CLEAR_PERI_REG_MASK
    #undef CLEAR_PERI_REG_MASK
    #define CLEAR_PERI_REG_MASK(reg, mask) REG_CLR_BIT((reg), (mask))
  #endif
#endif
...
// See commit https://github.com/Bodmer/TFT_eSPI/pull/3921/
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    #if defined(CONFIG_IDF_TARGET_ESP32C3) || defined(CONFIG_IDF_TARGET_ESP32C5) || defined(CONFIG_IDF_TARGET_ESP32C6) || defined(CONFIG_IDF_TARGET_ESP32H2) || defined(CONFIG_IDF_TARGET_ESP32S2)	//?// ESP32-C6 + ESP32-H2
      #if (TFT_MISO == -1)
        #undef TFT_MISO
...
//* Replacement slimmer macros
  ...
  #if !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32C5) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32H2)	//?// ESP32-C6 + ESP32-H2
